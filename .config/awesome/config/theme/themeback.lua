...
theme.bg_focus      = functions.change_color_alpha(theme.gtk.selected_bg_color, "AA")
...
theme.border_focus  = functions.change_color_alpha(theme.gtk.wm_border_focused_color, "CC")
...
theme.tasklist_bg_focus = functions.change_color_alpha(theme.border_focus, "66")
...
theme.taglist_bg_occupied = functions.change_color_alpha(theme.gtk.header_button_bg_color, "88")
...
theme.lain_icons         = os.getenv("HOME") ..
                           "/.config/awesome/theme/icons/layout/"
